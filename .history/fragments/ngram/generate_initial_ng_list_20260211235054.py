...
SAFE_KEYWORDS = ["楽譜", "琴譜", "笛譜", "三味線", "浄瑠璃", "謡本", "尺八", "工尺"]
...
def generate_ng_list():
    ...
    for word in candidates:
        ...
        # So "Noise" patterns usually override "Safe" patterns if they describe the *type* of document as a list/history.
        # But "歌譜" was removed from Noise list.
